...
const services = [
  {
    ...
    description:
      "Construo interfaces responsivas e interativas com foco em performance, utilizando tecnologias como React, Vue e JavaScript.",
    icon: Code,
  ...
  },
  {
    title: "Design UI/UX",
    description:
      "Crio experiências intuitivas e acessíveis que colocam o usuário no centro de cada decisão de design.",
    icon: Paintbrush,
  ...
  },
  {
    title: "Performance",
    description:
      "Acelero aplicações com foco em carregamento rápido, fluidez e alta performance em qualquer dispositivo.",
    icon: Rocket,
  ...
  <div className="space-y-16">
    ...
    <section className="py-5 px-12 mt-12">
      ...
      <p className="text-gray-400 text-lg max-w-2xl mx-auto text-center mb-12">
        Desenvolvo interfaces modernas, rápidas e intuitivas, aliando tecnologia
        e design com excelência.
      </p>
      <div className="grid md:grid-cols-3 gap-8">
        {services.map((service, index) => (
          ...
          >
            <div
              className={`mb-6 w-14 h-14 rounded-xl flex items-center justify-center bg-gradient-to-br ${service.iconBg}`}
            >
    ...
    <section className="flex justify-center items-center py-24">
      ...
      >
        ...
        <p className="text-gray-200 text-lg mb-8">
          Estou sempre aberto a novas ideias e projetos desafiadores. Me chama
          para conversar e transformar sua ideia em realidade!
        </p>
        <a
          href="/profile"
