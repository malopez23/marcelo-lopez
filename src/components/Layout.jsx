    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white w-full" style={{ margin: 0, padding: 0 }}>
      ...
      >
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-4">
          <a href="https://github.com/malopez23" className="text-gray-300 hover:text-purple-400" target='_blank'>
            <motion.div whileHover={{ rotate: -15 }}>
              <Github size={24} />
            </motion.div>
          </a>
          <a href="https://www.linkedin.com/in/marcelolopez23/" className="text-gray-300 hover:text-blue-400" target='_blank'>
            <motion.div whileHover={{ rotate: 15 }}>
              <Linkedin size={24} />
            </motion.div>
          </a>
          <a href="mailto:malopez.rodriguez23@gmail.com" className="text-gray-300 hover:text-orange-400" target='_blank'>
          ...
          >
            {navItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `py-2 pl-3 text-gray-300 hover:bg-purple-600/20 flex items-center gap-2 rounded-lg ${
                    isActive
                      ? 'bg-gradient-to-r from-purple-600/20 to-orange-600/20 text-white border border-purple-500/30'
                      : ''
                  }`
